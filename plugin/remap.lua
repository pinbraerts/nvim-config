...
vim.keymap.set("n", "[e", function()
  v.goto_prev({ severity = vs.ERROR })
end, { desc = "Go to previous error" })
vim.keymap.set("n", "]e", function()
  v.goto_next({ severity = vs.ERROR })
end, { desc = "Go to next error" })
vim.keymap.set("n", "[w", function()
  v.goto_prev({ severity = vs.WARNING })
end, { desc = "Go to previous warning" })
vim.keymap.set("n", "]w", function()
  v.goto_next({ severity = vs.WARNING })
end, { desc = "Go to next warning" })
vim.keymap.set("n", "[i", function()
  v.goto_prev({ severity = vs.INFO })
end, { desc = "Go to previous information" })
vim.keymap.set("n", "]i", function()
  v.goto_next({ severity = vs.INFO })
